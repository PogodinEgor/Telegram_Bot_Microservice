...
public class MainServiceImpl implements MainService {
    ...
    public void processTextMessage(Update update) {
        ...
        ServiceCommand serviceComand = ServiceCommand.fromValue(text);
        if (CANCEL.equals(serviceComand)) {
    ...
    private AppUser findOrSaveAppUser(Update update) {
        ...
        Optional<AppUser> appUserOpt = appUserDAO.findByTelegrammUserId(telegramUser.getId());
        if (appUserOpt.isEmpty()) {
            AppUser transientAppUser = AppUser.builder()
                    .telegrammUserId(telegramUser.getId())
